...
const GAMES = [
  { file: 'games/saper/index.html',      emoji: '💣',  name: 'Сапёр',            guide: 'games/saper/управление.txt',      accent: '#d8645a', cat: 'puzzle' },
  { file: 'games/tictactoe/index.html',  emoji: '⭕',  name: 'Крестики-нолики',  guide: 'games/tictactoe/управление.txt',  accent: '#5a84d8', cat: 'puzzle',   net: true },
  { file: 'games/pyatnashki/index.html', emoji: '🔢',  name: 'Пятнашки',         guide: 'games/pyatnashki/управление.txt', accent: '#2dbe69', cat: 'puzzle' },
  { file: 'games/clicker/index.html',    emoji: '🍪',  name: 'Печенька-кликер',  guide: 'games/clicker/управление.txt',    accent: '#e6c894', cat: 'build' },
  { file: 'games/pong/index.html',       emoji: '🏓',  name: 'Pong',             guide: 'games/pong/управление.txt',       accent: '#2dbe69', cat: 'arcade',   net: true },
  { file: 'games/snake/index.html',      emoji: '🐍',  name: 'Змейка',           guide: 'games/snake/управление.txt',      accent: '#57cc7a', cat: 'arcade' },
  { file: 'games/flappy/index.html',     emoji: '🐤',  name: 'Flappy',           guide: 'games/flappy/управление.txt',     accent: '#e6c894', cat: 'arcade' },
  { file: 'games/invaders/index.html',   emoji: '👾',  name: 'Space Invaders',   guide: 'games/invaders/управление.txt',   accent: '#ba94e6', cat: 'arcade' },
  { file: 'games/tetris/index.html',     emoji: '🧱',  name: 'Тетрис',           guide: 'games/tetris/управление.txt',     accent: '#5ab7d8', cat: 'puzzle' },
  { file: 'games/breakout/index.html',   emoji: '🕹️',  name: 'Арканоид',         guide: 'games/breakout/управление.txt',   accent: '#d8aa5a', cat: 'arcade' },
  { file: 'games/pacman/index.html',     emoji: '🟡',  name: 'Лабиринт',         guide: 'games/pacman/управление.txt',     accent: '#e6c894', cat: 'arcade' },
  { file: 'games/dino/index.html',       emoji: '🦕',  name: 'Динозаврик',       guide: 'games/dino/управление.txt',       accent: '#2dbe69', cat: 'arcade' },
  { file: 'games/timberman/index.html',  emoji: '🪓',  name: 'Timberman',        guide: 'games/timberman/управление.txt',  accent: '#2dbe69', cat: 'arcade' },
  { file: 'games/stack/index.html',      emoji: '🏗️',  name: 'Stack (Башня)',    guide: 'games/stack/управление.txt',      accent: '#5ab7d8', cat: 'arcade' },
  { file: 'games/copter/index.html',     emoji: '🚀',  name: 'Ракета в пещере',  guide: 'games/copter/управление.txt',     accent: '#d8aa5a', cat: 'arcade' },
  { file: 'games/blackjack/index.html',  emoji: '🃏',  name: 'Блекджек (21)',     guide: 'games/blackjack/управление.txt',  accent: '#2dbe69', cat: 'cards',    net: true },
  { file: 'games/durak/index.html',      emoji: '🎴',  name: 'Дурак',            guide: 'games/durak/управление.txt',      accent: '#d8645a', cat: 'cards',    net: true },
  { file: 'games/colony/index.html',     emoji: '🛰️',  name: 'Колония (выживание)', guide: 'games/colony/управление.txt',   accent: '#5ab7d8', cat: 'survival' },
  { file: 'games/survival/index.html',   emoji: '🌲',  name: 'Выживание (тайлы)', guide: 'games/survival/управление.txt',   accent: '#2dbe69', cat: 'survival', net: true },
  { file: 'games/raft/index.html',       emoji: '🛟',  name: 'Микро-Raft',       guide: 'games/raft/управление.txt',       accent: '#2d97be', cat: 'survival', net: true },
  ...
  { file: 'games/asteroid/index.html',   emoji: '☄️',  name: 'Дрейфующий астероид', guide: 'games/asteroid/управление.txt', accent: '#d8aa5a', cat: 'survival', net: true },
  { file: 'games/factory/index.html',    emoji: '🏭', name: 'Конвейер',         guide: 'games/factory/управление.txt',    accent: '#d8aa5a', cat: 'build' },
  { file: 'games/defense/index.html',    emoji: '🛡',  name: 'Рубеж',            guide: 'games/defense/управление.txt',    accent: '#d8aa5a', cat: 'build' },
  { file: 'games/witcher/index.html',    emoji: '🐺', name: 'Ведьмачий контракт', guide: 'games/witcher/управление.txt',  accent: '#be892d', cat: 'rpg' },
];
